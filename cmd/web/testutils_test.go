...
*/
//TODO: some issue with TestUserSignup test to fail
...
func newTestApplication(t *testing.T) *application {
	...
	/*
		// 14.5 Mocking dependencies: Initializing the mocks
...
func newTestServer(t *testing.T, h http.Handler) *testServer {
	// ts := httptest.NewTLSServer(h) // For testing HTTPS server
	// ts := httptest.NewServer(h) // For testing http server
	// return &testServer{ts}

	/*
		// 14.3 End-to-end testing: Cookies and redirections
...
// TODO: some issue with the test user signup function 
